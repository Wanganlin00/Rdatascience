...
date: today
description: "<br/>加油.<br/>day day up"
...
第一个[^dynamic_report-1]

[^dynamic_report-1]: WANG,A.,et al.(2025)

For instance[^dynamic_report-2], here is one attached to the word carrot[^dynamic_report-3].

[^dynamic_report-2]: dafhaifhafoahfo

[^dynamic_report-3]: The carrot (Daucus carota subsp. sativus) is a root vegetable, typically orange in color
...
<p keyboard <kbd>Ctrl+C</kbd>></p>


<P>小文本<small>Text</small></P>
</body>
```
### 内联代码
